...
public class LibrarianGroupEntity {
	private Integer id;
	private String name;
	...
	public LibrarianGroupEntity(Integer id, String name, LocalDateTime register_date, Integer teacher_id) {
		super();
		this.id = id;
		this.name = name;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LibrarianGroupEntity other = (LibrarianGroupEntity) obj;
